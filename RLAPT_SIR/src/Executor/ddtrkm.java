...
import GenerateTestSuit.get_partition4DDRT;
import GenerateTestSuit.testcase;
import Log.RecordResult;
import Strategy.DDRTKM;
...
public class ddtrkm implements test {
...
//    }
    ...
    public void executeTestCase(String program_name, String version, int repeatTimes) {
        ...
        for (int i = 0; i < constant.repeatnum; i++) {
            System.out.println(program_name + " " + version + " use DDRT ; now testing " + String.valueOf(i + 1));

            // initialize DRT
            DDRTKM ddrt = new DDRTKM();
            ddrt.setParameters4DRT(program_name);
            ddrt.initializeDRT(constant.get_num_of_partition(program_name));
            ...
            get_partition4DDRT.partiton_tc(tc, program_name);
...
//            }
            ...
            for (int j = 0; j < constant.testcasenum; j++) {
                ...
                if (counter == 1) {
                    ...
                    partitionIndex = ddrt.nextPartition4DRT();
                }
                ...
                ddrt.adjustDRT(partitionIndex, isKilledMutants);
        ...
        String txtLogName = "DDRT_" + program_name + "_" + version + ".txt";
        ...
        String txtSpecificName = "DDRT_" + program_name + "_" + version + "_Content.txt";
