...
public class DDRTKM {
    ...
    public void setParameters4DRT(String objectName) {
        if (objectName.equals("Grep")) {
            ...
            double[][] Mat = {{0.0, 10.0, 33.03028912982749, 33.0}, {10.0, 0.0, 23.043437243605826, 23.0}, {33.03028912982749, 23.043437243605826, 0.0, 1.4142135623730951}, {33.0, 23.0, 1.4142135623730951, 0.0}};
            setDRT_Mat(Mat);
