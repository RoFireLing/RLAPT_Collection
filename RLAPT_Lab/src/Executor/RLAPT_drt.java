...
//            } else break;
        ...
        for (int i = 0; i < Constant.repeatNumber; i++) {
            ...
            //初始化DRT
            RLAPT_DRT drt = new RLAPT_DRT();
            drt.setParameters4DRT(objectName, tcnum);
...
//                            }
        ...
        //记录均值结果方便查看
        String txtLogName = "DRT4" + objectName + "#" + tcnum + ".txt";
        ...
        txtLogName = "DRT4" + objectName + "#" + tcnum + "_Contents.txt";
