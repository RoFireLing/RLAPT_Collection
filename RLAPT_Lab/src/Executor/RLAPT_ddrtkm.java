...
public class RLAPT_ddrtkm implements NewStrategy {
//    public static void main(String[] args) {
//        RLAPT_drt drt = new RLAPT_drt();
//        for (int i = 0; i < 10; i++) {
//            drt.testing("CUBS", 500, i);
//        }
//    }
...
//            } else break;
        ...
        for (int i = 0; i < Constant.repeatNumber; i++) {
            System.out.println("RL-APT4" + objectName + "使用ddrt:" +
                    "执行第" + String.valueOf(i + 1) + "次测试：");

            //初始化DRT
            RLAPT_DDRTKM ddrt = new RLAPT_DDRTKM();
            ddrt.setParameters4DRT(objectName);

            //初始化测试剖面
            ddrt.initializeDRT(Constant.getPartitionNumber(objectName));
...
//                            }
        ...
        //记录均值结果方便查看
        String txtLogName = "DDRT4" + objectName + "#" + tcnum + ".txt";
        ...
        txtLogName = "DDRT4" + objectName + "#" + tcnum + "_Contents.txt";
