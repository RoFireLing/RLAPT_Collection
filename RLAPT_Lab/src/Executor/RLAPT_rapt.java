...
//            } else break;
        ...
        for (int i = 0; i < Constant.repeatNumber; i++) {
            ...
            //初始化RAPT
            RLAPT_RAPT rapt = new RLAPT_RAPT();
            rapt.setParameters4RAPT(objectName, tcnum);
...
//                            }
        ...
        //记录均值结果方便查看
        String txtLogName = "RAPT4" + objectName + "#" + tcnum + ".txt";
        ...
        txtLogName = "RAPT4" + objectName + "#" + tcnum + "_Contents.txt";
